...
def filterWord42Vocab(vocabObj, vocabObj1, vocabObj2):
	...
	commonWordStrList = list(set(wordStrList1).intersection(set(wordStrList2)))

	print("commonWordStrList", len(commonWordStrList))

	for wordStr in commonWordStrList:
		wordDF =  vocabObj1.m_wordDFMap[wordStr]+vocabObj2.m_wordDFMap[wordStr]
...
# def filterWordByDF(vocabObj, docList, DFthreshold = 50):
...
# 	docNum = len(docList)
# 	print("total doc num", docNum)

# 	thresholdDocNumMax = int(0.05*docNum)

# 	sortedWordStrList = sorted(vocabObj.m_wordDFMap, key=vocabObj.m_wordDFMap.__getitem__)
# 	preWordNum = len(sortedWordStrList)

# 	startWordIndex = int(preWordNum*0.3)
# 	endWordIndex = int(preWordNum*0.995)

# 	startWordStr = sortedWordStrList[startWordIndex]
# 	endWordStr = sortedWordStrList[endWordIndex]

# 	print("startDF", vocabObj.m_wordDFMap[startWordStr])
# 	print("endDF", vocabObj.m_wordDFMap[endWordStr])

# 	partialSortedWordStrList = sortedWordStrList[startWordIndex:endWordIndex]

# 	for wordStr in partialSortedWordStrList:
...
# inputFile_pos_kitchen = "../../../dataset/processed_acl/kitchen/positive.review"
# inputFile_neg_kitchen = "../../../dataset/processed_acl/kitchen/negative.review"

# readReviewFile(inputFile_pos_kitchen, vocabObj1, docList1, "kitchen", True)
# readReviewFile(inputFile_neg_kitchen, vocabObj1, docList1, "kitchen", False)
...
saveReview(outputFile, vocabObj, docList2, "electronics")
saveVocab(outputFile, vocabObj, "books_electronics")
