"""
proactive learning with random initialization, use random to select instances, reuse previous wrong transferred instances and we use slab threshold to filter instances
"""
...
if __name__ == "__main__":
	...
	modelName = "AAWS_random_slab_"+dataName
