"""
proactive learning with random initialization, an auditor to judge whether transfer learning is correct. Reuse previous wrong transferred instances, in ascending order
"""
...
class _ProactiveLearning:
	...
	def getTransferRefScore(self, transferFeatureList, transferFlagList, targetNameFeatureValid, targetLabelValid):
		...
		correctRef = 0.0
		validExNum = 0.0
		for validEx in sortedValidExList:
			validPredLabel = targetLabelValidPreds[validEx]
			if validPredLabel == targetLabelValid[validEx]:
				correctRef += 1.0
			validExNum += 1.0
...
if __name__ == "__main__":
	...
	modelName = "AAWS_validation_"+dataName
