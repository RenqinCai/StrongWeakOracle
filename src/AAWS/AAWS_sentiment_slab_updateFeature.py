"""
proactive learning with random initialization, reuse previous wrong transferred instances and we use slab threshold to filter instances. We update the feature representation with labeled instances by strong oracle.
"""
...
class _ProactiveLearning:
	...
	def select_example(self, unlabeled_list):
		...
		for unlabeledIdIndex in range(unlabeledIdNum):
			...
			unlabeledIdScoreMap[unlabeledId] = scoreWeightClassifier*idScoreClassifier 
	...
	def generateCleanData(self, train, slabThreshold):
		...
		return cleanFeatureTrain, cleanLabelTrain, cleanTrain
	...
	def run_CV(self):
		...
		for foldIndex in range(foldNum):
			...
			cleanFeatureTrain, cleanTransferLabelTrain, cleanTrain = self.generateCleanData(train, slabThreshold)
...
if __name__ == "__main__":
	...
	modelName = "AAWS_slab_updateFeature_"+dataName
