"""
active learning with a strong oracle and weak labels are given. use slab as auditor, and use the true centroid to estimate reliability of weak labels
"""
...
if __name__ == '__main__':
	...
	modelName = "trueSlabAuditor_"+dataName
