"""
active learning with a strong oracle and weak labels are given. use weak labels to train a weak clf and select instances based on the difference theta_{strong}X-theta_{weak}X
"""
...
class _ActiveClf:
	...
	def activeTrainClf(self, corpusObj):
		...
		self.m_weakClf.fit(weak_feature_train_iter, weak_label_train_iter)
		...
		while strongLabelNumIter < self.m_strongLabelNumThresh:
			...
			# predLabelTest = self.m_weakClf.predict(corpusObj.m_feature[self.m_test])
...
if __name__ == '__main__':
	...
	modelName = "StrongWeakDiff_"+dataName
