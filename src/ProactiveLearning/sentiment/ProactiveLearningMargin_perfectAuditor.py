"""
proactive learning margin with random initialization, a perfect auditor to tell whether the transferred label is correct or not.
"""
...
modelName = "margin_perfectAuditor_"+dataName
