"""
proactive learning margin with random initialization, heuristic rule to judge whether transfer learning is correct, theta_active^TX times theta_weak^TX. 
"""
...
modelName = "LUCB_NewRuleAuditor_"+dataName
...
class _ProactiveLearning:
	...
	def get_transfer_flag(self, exId):
		...
		predCB = self.get_select_confidence_bound(exId)

		auditorProb = auditorProb*predProb-self.m_cbRate*predCB
