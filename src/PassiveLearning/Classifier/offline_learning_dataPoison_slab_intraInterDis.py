"""
offline learning via considering weak labels as data poison and remove poisoned data to train a better classifier, compare distance of features via slab threshold, including both intra-distance within class and inter-distance cross class.
"""
...
class active_learning:
	...
	def run_CV(self):
		...
		if self.m_category == "text":
			...
			thresholdList = np.arange(1.00, 1.20, 0.01)
