...
class active_learning:
	...
	def run_CV(self):
		...
		for foldIndex in range(foldNum):
			...
			precision = precision_score(label_test, label_preds)
		...
		print("totalPrecisionList", totalPrecisionList, np.mean(totalPrecisionList), np.sqrt(np.var(totalPrecisionList)))
...
if __name__ == "__main__":
	...
	if dataName == "electronics":
		...
		al = active_learning(fold, rounds, featureMatrix, auditorLabelArray, "text", multipleClassFlag)
